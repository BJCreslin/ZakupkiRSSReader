...
public class Channel {
    //
    private ItemFromXML[] itemFromXML;
...
//   <title>Результаты поиска в реестре заказов и закупок</title>
    ...
    public ItemFromXML[] getItemFromXML() {
        return itemFromXML;
    }

    public void setItemFromXML(ItemFromXML[] itemFromXML) {
        this.itemFromXML = itemFromXML;
    }
    ...
    public String toString() {
        return "ClassPojo [item = " + itemFromXML + ", link = " + link + ", description = " + description + ", title = " + title + "]";
    }
}
